...
/** @var app\models\EoqRopHistorySearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="eoq-rop-history-search">
    ...
    <?= $form->field($model, 'eoq_rop_history_id') ?>
    ...
    <?= $form->field($model, 'safety_stock_snapshot') ?>

    <?php // echo $form->field($model, 'lead_time_snapshot') ?>

    <?php // echo $form->field($model, 'demand_snapshot') ?>

    <?php // echo $form->field($model, 'total_biaya_perediaan') ?>
